...
import 'package:app/screens/profile/displayBadges.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    ...
    print(userProvider.user!.access_token);
    // ApiService()
    //     .getUserBadges(userProvider.user!.id, userProvider.user!.access_token);
    ApiService().getValidityPlans(userProvider.user!.access_token);
    ApiService()
        .getAllPoints(userProvider.user!.id, userProvider.user!.access_token);
  }
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                          "Badges : 100 km badge, 200 km badge"),
                                    ],
                                  ),
                                ),
                                SizedBox(
