    ...
    return Scaffold(
      ...
      child: Column(
        children: [
            ...
            items: items.map((i) {
              return Builder(
                builder: (BuildContext context) {
                  return Container(
                    padding: EdgeInsets.symmetric(horizontal: Sizer.sbh * 2),
          ...
          SizedBox(height: Sizer.sbv * 2),
          OTREventCard(
              event: current_otr, displayText: true, showCarousel: false),
          SizedBox(height: Sizer.sbv * 2),
          Container(
              width: Sizer.screenWidth * 0.8,
              alignment: Alignment.center,
                  ...
                  child: InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => OTREventPage(event: i)));
                      },
                      child: OTREventCard(
                          event: i, displayText: false, showCarousel: false)));
            }).toList(),
          ),
          DotsIndicator(
          ...
          InkWell(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => OTRHistory()));
            },
            child: Container(
              width: Sizer.sbh * 40,
              height: Sizer.sbh * 8,
